...
项目采用现代化的技术栈组合，结合了Vue3的组件化开发优势和FastAPI的高性能后端服务，为开发者提供了开箱即用的语音处理工具集。**最新版本**增加了ZMQ赛事解说功能，支持实时事件流处理和多后端TTS合成。
...
- **qwen-to-data7.py**：ZMQ赛事解说主程序，支持多后端TTS
...
CheckBatchSize --> |达到阈值| GenerateNarration[生成解说文本]
